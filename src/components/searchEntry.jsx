...
const SearchEntry = (props) => (
      <div className='gameItem'>
        <span className='gameImage'><img class='gameImageImg' src={props.item.image_url ? props.item.image_url : "https://reactnativecode.com/wp-content/uploads/2018/02/Default_Image_Thumbnail.png"}></img></span><br />
